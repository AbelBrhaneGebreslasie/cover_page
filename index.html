...
<head>
  ...
  <style>
    ...
    .welcome-text {
      ...
      letter-spacing: 1px;
      text-shadow: 4px -4px 4px rgba(0, 0, 0, 0.5); /* Increased text shadow length */
    ...
    .image-container {
      ...
      box-shadow: 10px -20px 5px rgba(0, 0, 0, 0.5); /* Increased shadow length */   
     }
...
<body>
  <div id="curved-text" class="welcome-text">Welcome to the Hotel</div>
